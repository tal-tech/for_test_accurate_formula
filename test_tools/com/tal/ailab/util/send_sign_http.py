from com.tal.ailab.util.http import send_patch,send_post,send_delete,send_get,send_put
from com.tal.ailab.util.sign_client import get_signature
import json


def __url_format(parameters):
    param_list = []
